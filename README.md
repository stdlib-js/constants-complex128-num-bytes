...
```javascript
COMPLEX128_NUM_BYTES = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex128-num-bytes@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex128-num-bytes@umd/bundle.js"></script>
```
