...
```javascript
COMPLEX128_NUM_BYTES = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex128-num-bytes@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-complex128-num-bytes/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-complex128-num-bytes/actions/workflows/test.yml?query=branch:v0.2.3
